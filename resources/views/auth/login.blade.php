...
@section('content')
    ...
    <div>
        <div class="bg-image d-flex justify-content-center align-items-center min-vh-100 px-3">
            <div class="justify-content-center pt-2 pb-4">
            ...
            <div class="border mx-3 bg-white shadow p-4 rounded" style="width: 100%; max-width: 450px;">
                ...
                <form action="{{ route('auth-login') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" value="{{ old('email') }}" name="email" class="form-control rounded"
                    ...
                    <div class="d-flex gap-2 mt-1 justify-content-center">
                        @foreach ($sosmed as $data)
                            <div class="d-flex flex-column align-items-center">
                                <img src="{{ asset('storage/' . $data->foto) }}" class="rounded-circle"
                                    style="height: 30px; width: 32px; object-fit: cover;">
