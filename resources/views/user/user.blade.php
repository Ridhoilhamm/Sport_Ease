            ...
            <div style="overflow-x: auto; white-space: nowrap; position: relative;">
                <div style="display: inline-flex; min-width: 100%; width: fit-content;">
                    ...
                    <div style="flex-shrink: 0; width: 120px; margin-right: 10px; position: relative;">
                        <img src="{{ asset('image/badminton.jpg') }}" alt="Potong Rambut" class="rounded d-block"
                            style="height: 140px; width: 100%; border: none; box-shadow: none; object-fit: cover;">
                        <div class="mt-1 text-center">
                            <p class="mb-0 " style="font-size: 12px">L. Badminton</p>
                    ...
                    <!-- Slide 2 -->
                    <div style="flex-shrink: 0; width: 120px; margin-right: 10px; position: relative;">
                        <img src="{{ asset('image/lapangan-golf.jpg') }}" alt="Semir Rambut" class="rounded d-block"
                            style="height: 140px; width: 100%; border: none; box-shadow: none; object-fit: cover;">
                        <div class="mt-1 text-center">
                            <p class="mb-0" style="font-size: 12px">L. Golf</p>
                        </div>
                    </div>
                    ...
                    <div style="flex-shrink: 0; width: 120px; margin-right: 10px; position: relative;">
                        <img src="{{ asset('image/futsal.jpeg') }}" alt="Styling Rambut" class="rounded d-block"
                            style="height: 140px; width: 100%; border: none; box-shadow: none; object-fit: cover;">
                        <div class="mt-1 text-center">
                            <p class="mb-0" style="font-size: 12px;">L. Futsal</p>
                        </div>
                    </div>

                    <!-- Slide 4 -->
                    <div style="flex-shrink: 0; width: 120px; margin-right: 10px; position: relative;">
                        <img src="{{ asset('image/kolam-renang.jpg') }}" alt="Pijat Kepala" class="rounded d-block"
                            style="height: 140px; width: 100%; border: none; box-shadow: none; object-fit: cover;">
                        <div class="mt-1 text-center">
                            <p class="mb-0" style="font-size:12px;">K. Renang</p>
                    ...
                    <!-- Slide 5 -->
                    <div style="flex-shrink: 0; width: 120px; margin-right: 10px; position: relative;">
                        <img src="{{ asset('image/lapangan volly.jpeg') }}" alt="Perawatan Kepala"
                            class="rounded d-block"
                            style="height: 140px; width: 100%; border: none; box-shadow: none; object-fit: cover;">
                        <div class="mt-1 text-center">
                            <p class="mb-0" style="font-size: 12px">L. Volly</p>
                        </div>
                    </div>

                    <!-- Slide 6 -->
                    <div style="flex-shrink: 0; width: 120px; position: relative;">
                        <img src="{{ asset('image/download.jpeg') }}" alt="Cukur Jenggot" class="rounded d-block"
                            style="height: 140px; width: 100%; border: none; box-shadow: none; object-fit: cover;">
                        <div class="mt-1 text-center">
                            <p class="mb-0" style="font-size:12px ">L. Basket</p>
